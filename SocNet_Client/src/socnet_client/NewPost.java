...
public class NewPost extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please enter your new post:");

        jTextField1.setToolTipText("Enter your message here");

        jButton1.setText("Submit");
        jButton1.setToolTipText("Submit your post");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Submits the new post to the system.
        String post = jTextField1.getText();
        if(post != null && post.length() < 500)
        {
